...
- The final release manifest uses schema 2 and records the package-producing Git commit as `source_commit`; `release-validate` requires it to equal the current `HEAD`.
