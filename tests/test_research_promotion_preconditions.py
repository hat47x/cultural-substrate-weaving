...
HEAD_BINDING = "complete-checkout PASS evidence execution commit matches the current checkout HEAD"
...
class ResearchPromotionPreconditionTests(unittest.TestCase):
    ...
    def test_head_binding_precondition_cannot_be_removed(self) -> None:
        descriptor = copy.deepcopy(self.descriptor)
        descriptor["promotion_preconditions"].remove(HEAD_BINDING)
    ...
    def test_duplicate_precondition_is_rejected(self) -> None:
        descriptor = copy.deepcopy(self.descriptor)
        descriptor["promotion_preconditions"].append(HEAD_BINDING)
