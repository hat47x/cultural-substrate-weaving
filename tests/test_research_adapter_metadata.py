...
class ResearchAdapterMetadataTests(unittest.TestCase):
    ...
    def test_current_openai_coverage_separates_runtime_and_metadata_maturity(self) -> None:
        ...
        self.assertEqual(en["runtime_state"], "buildable")
        self.assertEqual(en["metadata_coverage"], "incomplete-for-realized")
        ...
        self.assertEqual(en_items["affinity-synthesis"]["metadata_state"], "planned")
        self.assertEqual(en_items["iterative-inquiry-synthesis"]["metadata_state"], "planned")
