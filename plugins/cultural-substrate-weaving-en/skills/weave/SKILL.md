---
name: weave
description: A complementary AI skill that keeps its interpretation revisable by the target, opens cultural frameworks as temporary cognitive fields, preserves attribution of framework-generated candidates, and returns them to target-side material for validation. When compatible realizations are available, one-round material synthesis and multi-round delta/reopen orchestration are delegated rather than owned by CSW. Domain expertise comes from the calling context, available materials, or companion skills.
...
2. **Establish the cognitive stance**: follow `references/00-cognitive-stance.md` and do not fix your explanation above the target.
...
4. **Delegate material synthesis when needed**: if numerous or heterogeneous materials need material-led structure discovery, use the connection contract in `references/10-integration.md` to hand them to a compatible synthesis realization.
...
8. **Hand off a round delta when needed**: if a new framework contact touches prior artifacts or residuals, use the connection contract in `references/00-iteration.md` to hand it to a compatible iterative realization.
...
|---|---|
| Cognitive stance toward the target | [00-cognitive-stance.md](references/00-cognitive-stance.md) |
| Use scope and loading depth | [00-activation.md](references/00-activation.md) |
...
| Handing new framework contact to a round delta | [00-iteration.md](references/00-iteration.md) |
...
| Relation types, target-framework tension, missing connections, multiple frameworks | [03-transformation.md](references/03-transformation.md) |
...
| Connection to affinity synthesis for numerous / heterogeneous materials | [10-integration.md](references/10-integration.md) |
