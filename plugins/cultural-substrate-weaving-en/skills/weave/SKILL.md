...
5. **Open a cultural framework to the needed depth**: `not_loaded / probe / preview / full / enacted`. Normally begin with a target-led probe. In exploratory use, when light contact with a candidate framework's overall structure is itself meaningful, preview may also be used as an entry before a target-side question is fully formed. See `references/00-activation.md`.
