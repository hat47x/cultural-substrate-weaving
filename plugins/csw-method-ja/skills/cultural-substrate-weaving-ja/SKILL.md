...
- **全体適用**：`00-principles-and-constraints.md`と`01-scope-and-facts.md`から始める。材料が多数・異種、または主要構造が未確定の場合は`10-integration.md`を先に読む。体系選定時に`02-system-selection.md`、変換時に`03-transformation.md`、確定前に`09-evaluation-and-domains.md`を読む。
