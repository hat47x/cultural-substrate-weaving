...
5. **文化体系を必要な深さで開く**：`not_loaded / probe / preview / full / enacted`。通常は対象起点のprobeから始める。探索利用で候補体系の全体像へ軽く触れること自体に意味がある場合は、対象側の問いを先に完成させずpreviewから入ってもよい。詳細は`references/00-activation.md`。
...
- **探索利用**：認知姿勢を置き、`01-scope-and-facts.md`を確認する。材料が多ければ`10-integration.md`を使う。文化体系への入口は`00-activation.md`で決め、対象起点ならprobe、体系起点なら必要に応じてpreviewから入り、`02-system-selection.md`→`02a-framework-application.md`へ進む。
