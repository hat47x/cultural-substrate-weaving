...
5. **文化体系を必要な深さで開く**：`not_loaded / probe / preview / full / enacted`。通常はprobeから始めるが、探索利用では条件に応じてpreviewを入口にしてよい。詳細は`references/00-activation.md`。
...
- **探索利用**：認知姿勢を置き、`references/01-scope-and-facts.md`を確認する。材料が多ければ`references/10-integration.md`を使う。文化体系は通常probeから始め、体系起点の探索では必要に応じてpreviewから入り、`references/02-system-selection.md`→`references/02a-framework-application.md`へ進む。
