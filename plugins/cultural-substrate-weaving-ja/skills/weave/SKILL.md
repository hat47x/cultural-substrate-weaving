...
| 判断・処理 | 読むファイル |
|---|---|
| 発動判断、明示指定、途中終了 | [00-activation.md](references/00-activation.md) |
| 帰属、規則競合、正当化 | [00-principles-and-constraints.md](references/00-principles-and-constraints.md) |
| 周回、再材料化、増分停止 | [00-iteration.md](references/00-iteration.md) |
| 適用範囲、基準線、保持事項、事実整理 | [01-scope-and-facts.md](references/01-scope-and-facts.md) |
| 文化的体系の選定、同種性、不採用条件 | [02-system-selection.md](references/02-system-selection.md) |
| 割当、遷移試行、反転・代替・除去検査 | [02a-framework-application.md](references/02a-framework-application.md) |
...
| 静的／動的分離、判断来歴 | [08-governance-and-records.md](references/08-governance-and-records.md) |
| 最終評価、領域スキルとの境界 | [09-evaluation.md](references/09-evaluation.md) |
