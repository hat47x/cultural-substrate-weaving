...
さらに同日の直接チャット補正へ戻ると、文化体系を大胆に導入する一方で、それ以前に有効だった元材料、評価軸、文体、人物、構成などを文化体系の下位へ並べ替えないよう明示的な修正が入っていた。この意味差をHC-029「強い新枠組みを導入しても、それ以前の有効な経路を従属させない」として追加した。G3の「体系側からの認知供給」とG6候補の「役割を保った重層化」をつなぐ材料として保持する。一方、評価指標と作品の生命を交換条件にしない補正はHC-022 / G6、五行を表層象意へ縮めず変化文法として使う補正はHC-023 / 現行`transformation.md`の再出現と判定し、Øとして新カード化していない。詳細は `2026-09-04-recent-direct-chat-kj-followup.md` を参照する。

現在は新しい規則を急いで増やす段階ではない。残差は次のように扱う。

- **R1――文化体系側からの予期しない認知供給**：候補想起経路を含む大きな静的欠落はPR #127までで後退した。今後は、現在の対象語彙に近い体系だけでなく構造型の異なる候補が実際に認知場へ上がるか、`preview`から新しい問い・対比・調査先が生じるか、それらを`framework_generated`のままKJと対象へ戻せるか、全面対応や機械的な総当たりへ滑らないかという挙動上の残差を見る。複数体系compositionは現行`transformation.md`に役割分離、直交重層、軸の独立性、異なる情報種別の担当まで明示済みである。Issue #144では、candidate recallで複数候補が自然に立ったとき、この既存能力が実行時に必要な深さで前景化されるかだけを観察する。HC-029は、体系側から強い認知供給を受けても他の有効な認知経路を従属させないという自然利用材料を加えるが、これも現時点では静的欠落とは扱わない。
...
- `2026-09-04-recent-direct-chat-kj-followup.md`
  - 最近の直接チャット補正へ戻り、評価指標と作品生命を交換条件にしない反復、文化体系を表層象意へ縮めない反復は既存HC/G6/`transformation`へØとして戻し、意味差のあるHC-029だけを追加した。
  - HC-029は、文化体系のような強い新枠組みを大胆に導入しても、元材料、KJ、評価、文体、人物、構成など、それ以前から有効だった異質な認知経路をその枠組みの下位へ並べ替えないことを扱う。
  - G3とG6候補の間をつなぐ自然利用材料として保持するが、新しい静的runtime規則の要求とはしていない。
