...
- Extended natural-Japanese prose review freshness from development/maintainer material to the public Japanese README, getting-started and usage guides, and platform guides; refreshed the reviewed prose without changing runtime method semantics, added the current GitHub-marketplace workspace import path to the Codex guide, and clarified that Microsoft 365 Agent Builder's 20-item limit applies to files uploaded directly from the device as embedded knowledge sources.
