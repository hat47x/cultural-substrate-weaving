...
> **現在は検証段階です。** v0.4.0でWeb Chat Living Labを導入し、公開済みのv0.4.0方法論を実作業の中でprospectiveに観測しています。公開観測はまだ限定的であり、現時点で本スキルの有効性が確立したとは扱いません。→ **[Web Chat Living Lab](docs/ja/experiments/web-chat-living-lab.md)** / **[公開観測記録](research/living-lab/observations/)**
