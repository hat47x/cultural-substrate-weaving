...
- 対象: 公開トップページ、利用者向けガイド、日本語で記述する開発・保守・研究・実験・運用文書
...
- 生成物: 元文書やテンプレートを修正し、生成結果そのものを直接推敲しない。
...
この工程は、文章を装飾的にするためのものではない。技術文書や利用者向けガイドの意味を、読者が頭の中で余計な翻訳をしなくても受け取れる形へ整えるための工程である。
