...
4. **Return and check:** uncover the material, compare, and repair the distortion. Repair it rather than discarding it and writing something new. **Look for what was added that the original did not hold: causation, a person's inner state, a generalization, a direction of evaluation, a change in confidence (a guess turned into an assertion, hearsay turned into fact). Those five are the ones that get added.** And **write down the differences you dropped on purpose.** A difference dropped without a record of the dropping cannot be recovered later.
