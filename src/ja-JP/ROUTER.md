...
5. **文化体系を必要な深さで開く**：`not_loaded / probe / preview / full / enacted`。通常は対象起点のprobeから始める。探索利用で候補体系の全体像へ軽く触れること自体に意味がある場合は、対象側の問いを先に完成させずpreviewから入ってもよい。詳細は`core/activation.md`。
