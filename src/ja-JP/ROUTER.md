...
5. **文化体系を必要な深さで開く**：`not_loaded / probe / preview / full / enacted`。通常はprobeから始めるが、探索利用では抽象probeだけで閉じず、`methods/system-selection.md`の候補想起アンカーから構造型の異なる少数の体系を候補へ上げてpreviewしてよい。詳細は`core/activation.md`。
