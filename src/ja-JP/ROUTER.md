...
2. **認知姿勢を置く**：本スキルを使う条件が与えられている場合、`core/cognitive-stance.md`を最初に一度読み、対象から自分の読みを修正され得る位置に置く。
...
- **本スキルを使う条件を受け取った後**：`core/cognitive-stance.md`を最初に一度読む。同じラウンドで機械的に繰り返し読み込まない。
